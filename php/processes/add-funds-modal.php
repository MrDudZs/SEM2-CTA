...
$sql = "SELECT w.wallet_id, c.currency_name 
        FROM wallet AS w
...
while ($row = $result->fetch_assoc()) {
    $currencies[$row['wallet_id']] = $row['currency_name']; // Store wallet_id as key
}
$stmt->close();
?>
...
<style>
    ...
    /*Code for Card: https://uiverse.io/3bdel3ziz-T/helpless-wasp-32*/
</style>
